...
```
Handles method calls when a method is not implemented. Throws [Phalcon\Mvc\Model\Exception][mvc-model-exception] if the method doesn't exist
...
## Creating Models
A model is a class that extends from [Phalcon\Mvc\Model][mvc-model]. Its class name should be in camel case notation:
...
As you can see, there is no need to use raw SQL statements. [Phalcon\Mvc\Model][mvc-model] provides high database abstraction for web applications, simplifying database operations.
...
Note that resultsets can be serialized and stored in a cache backend. [Phalcon\Cache](cache) can help with that task. However, serializing data causes [Phalcon\Mvc\Model][mvc-model] to retrieve all the data from the database in an array, thus consuming more memory while this process takes place.
...
## Identity Columns
Some models may have identity columns. These columns usually are the primary key of the mapped table. [Phalcon\Mvc\Model][mvc-model] can recognize the identity column omitting it in the generated `INSERT` SQL statements, to allow the database system to correctly generate a new value for that field. After creating a new record, the identity field will always be registered with the value generated in the database system for it:
...
## Transactions
[Transactions](db-models-transactions) are necessary to ensure data integrity, when we need to insert or update data in more than one table during the same operation. [Phalcon\Mvc\Model][mvc-model] exposes the `setTransaction` method that allows you to bind each model to an active transaction.
...
[mvc-model-binderinterface]: api/phalcon_mvc#mvc-model-binderinterface
[mvc-model-criteria]: api/phalcon_mvc#mvc-model-criteria
[mvc-model-criteriainterface]: api/phalcon_mvc#mvc-model-criteriainterface
[mvc-model-exception]: api/phalcon_mvc#mvc-model-exception
[mvc-model-manager]: api/phalcon_mvc#mvc-model-manager
[mvc-model-managerinterface]: api/phalcon_mvc#mvc-model-managerinterface
[mvc-model-query]: api/phalcon_mvc#mvc-model-query
[mvc-model-query-builder]: api/phalcon_mvc#mvc-model-query-builder
[mvc-model-query-builderinterface]: api/phalcon_mvc#mvc-model-query-builderinterface
[mvc-model-query-lang]: api/phalcon_mvc#mvc-model-query-lang
[mvc-model-query-status]: api/phalcon_mvc#mvc-model-query-status
[mvc-model-query-statusinterface]: api/phalcon_mvc#mvc-model-query-statusinterface
[mvc-model-queryinterface]: api/phalcon_mvc#mvc-model-queryinterface
[mvc-model-relation]: api/phalcon_mvc#mvc-model-relation
[mvc-model-relationinterface]: api/phalcon_mvc#mvc-model-relationinterface
[mvc-model-resultinterface]: api/phalcon_mvc#mvc-model-resultinterface
...
[mvc-model-resultsetinterface]: api/phalcon_mvc#mvc-model-resultsetinterface
[mvc-model-row]: api/phalcon_mvc#mvc-model-row
[mvc-model-validationfailed]: api/phalcon_mvc#mvc-model-validationfailed
[mvc-modelinterface]: api/phalcon_mvc#mvc-modelinterface
